  ...
  try {
    ...
    if (type == 2) {
      ...
      whiteCard = new NymPosttwo({
        ...
        nymFontSize: "460px", // Default font size for Nym text
        nymLineHeight: "534.98px", // Default line height for Nym text
        Nym: name,
        NymColor: "#FFFFFF",
        formatNym: false, // Add this default parameter
        top: 349, // Top position for the text
        left: 518, // Left position for the text
        nymWidth: 2915, // Width for Nym text
        nymHeight: 2244, // Height for Nym text
      });
